        ...
        <div class="container">
            <v-row class="text-center">
                ...
                <v-col cols="12" sm="12" md="12">
                    <v-card class="mx-auto" max-width="800" hover style="border-radius: 15px;">
                        <v-card-title>
                            <v-col cols="12">
                                <h2>อุณหภูมิและความชื่น</h2>
                            </v-col>
                        </v-card-title>
                        <v-card-text>
                            <v-row>
                                <!-- วงกลมซ้ายบน: อุณหภูมิ -->
                ...
                <v-col cols="12">
                    <v-card class="mx-auto" max-width="900" hover style="border-radius: 15px;">
                        <v-row>
                            <v-col cols="12" sm="6">
                                <v-btn block style="background-color: greenyellow;color: #fff;height: 60px;"
                                    @click="start">เริ่ม</v-btn>
                            </v-col>
                            <br>
                            <v-col cols="12" sm="6">
                                <v-btn block style="background-color: red;color: #fff;height: 60px;"
                                    @click="stop">หยุด</v-btn>
                            </v-col>
                        </v-row>
                        ...
                        <v-card-text>
                            <v-row>
                                <v-col cols="12">
                                    ...
                                    <v-progress-linear color="deep-orange" height="20" :model-value="value_temp"
                                        striped></v-progress-linear>
                                    <v-progress-linear color="light-blue" height="20" :model-value="value_humi"
                                        striped></v-progress-linear>
                                    ผลรวม
            ...
            <v-row>
                ...
                <v-col cols="12" sm="12" md="4">
                    <v-card class="mx-auto" max-width="300" hover style="border-radius: 15px;">
                        <v-card-title>
                            <h3 style="text-align: center;">การควบคุมการทดสอบ</h3>
                        </v-card-title>
                        <v-card-text>
                            <v-row>
                                <!-- New button with 6 steps -->
                                <v-col cols="12">
                                    <v-btn @click="cycleLights" class="mt-2"
                                        :style="{ backgroundColor: getButtonColor(index) }" block :disabled="!isOn">
                                        {{ stepButtonLabel }}
                                    </v-btn>
                                </v-col>
                            </v-row>
...
export default {
    ...
    methods: {
        ...
        onMqttConnect() {
            ...
            this.client.subscribe('test/captain/itd1');
